...
> 本文记录原始 Worker 里程碑。实验分支新增成功回信后的异步摘要调度，独立互斥/续租、退避重试和重启恢复；详见[持续记忆增量](./phase3-exp-persona-harness-fusion.md#41-持续关系与长期记忆2026-09-08)。它不阻塞已回复信件的展示，真实效果待 Steam 复验。
