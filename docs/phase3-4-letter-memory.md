...
> 本文保留最初有限记忆里程碑。下文“默认关闭”和只保留近期窗口属于历史设计。实验分支模板已默认开启 `olivia-soul.sqlite`，新增分层长期记忆、关系账本和自动迁移；实现、验收及 Steam 复验见[融合实验 §4.1](./phase3-exp-persona-harness-fusion.md#41-持续关系与长期记忆2026-09-08)。这些改动仍只在实验分支。
