...
const keys = new Set(['id','version','revision','sha256','effectiveSha256','chars','provider','harness','persona','memory','fallback',
  ...
  'policy','action','enabled','maxChars','contextChars','signature','sourceLetterId','startedAt','endedAt']);
const nested = new Set(['assets','stages','calls','providerFailures','actualModule','module','base','baseMetadata','execution','harness','outputPolicy','persona','memory','configured','warnings','sources']);
